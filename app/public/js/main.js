...
/***/ function(module, exports, __webpack_require__) {
	...
	_EthereumNetwork.EthereumNetwork.createNode(false, MICROBE_ADDR.ip, MICROBE_ADDR.port).then(function (bootnode) {
	  ...
	  MACROPHAGE_ADDRS.forEach(function (macrophageAddr) {
	  ...
	  Promise.all(createNodePromises).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EthereumNetwork = undefined;

	var _globals = __webpack_require__(3);

	var _MacrophageManager = __webpack_require__(4);

	var _EthereumNode = __webpack_require__(5);

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var EthereumNetwork = function EthereumNetwork() {
	  _classCallCheck(this, EthereumNetwork);
	};
	...
	*/
	EthereumNetwork.createNode = function (isMiner, serverIP, serverPort) {
	  ...
	  var defer = new Promise(function (resolve, reject) {
	    ...
	    newNode.callWS({ flag: 'createGethInstance', nonce: currentNonce, isMiner: isMiner }, function (node, _ref) {
	      var err = _ref.err;
	      var rpcport = _ref.rpcport;

	      if (err) {
	        console.error(err);
	      } else {
	        newNode.initializeConnection(rpcport).then(function () {
	...
	*/
	EthereumNetwork.addNode = function (node) {
	  ...
	  this._nodeFilterCallbacks.forEach(function (callback) {
	    callback(node);
	  });
	};
	...
	*/
	...
	EthereumNetwork.toggleMicrobe = function (_microbe) {
	  ...
	  _microbe.setRole(_globals.MICROBE);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.macrophageManager = undefined;
	...
	var MaxPeerConnections = 1;

	var MacrophageManager = function () {
	  function MacrophageManager() {
	    _classCallCheck(this, MacrophageManager);
	  ...
	  _createClass(MacrophageManager, [{
	    ...
	    value: function toggleMacrophage(_macrophage) {
	      ...
	      _macrophage.setRole(_globals.MACROPHAGE);
	    }
	  }, {
	    key: 'getMacrophages',
	    ...
	    value: function pruneDuplicatePeers() {
	      var _this = this;

	      this._knownPeersConnections = {};

	      this._macrophages.forEach(function (macrophage) {
	        macrophage.getPeers().then(function (_ref) {
	          ...
	          peers.forEach(function (peer) {
	            if (!_this._knownPeersConnections[peer.ID]) {
	              _this._knownPeersConnections[peer.ID] = 0;
	            }

	            if (_this._knownPeersConnections[peer.ID] >= MaxPeerConnections) {
	...
	var macrophageManager = new MacrophageManager();
	exports.macrophageManager = macrophageManager;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EthereumNode = undefined;
	...
	var EthereumNode = function () {
	  ...
	  _createClass(EthereumNode, [{
	    ...
	    value: function callWS(data, callback) {
	      ...
	      var waitForInit = setInterval(function () {
	        if (_this2._ws && _this2._ws.readyState) {
	          ...
	          _this2._ws.send(JSON.stringify(data));
	        }
	      }, 500);
	    }
	    ...
	    */
	    ...
	    value: function initializeConnection(port) {
	      var _this3 = this;

	      var web3 = new Web3(new Web3.providers.HttpProvider('http://' + this._serverIP + ':' + port));
	      web3._extend({
	        'property': 'admin',
	      ...
	      var defer = new Promise(function (resolve, reject) {
	        var nodeInfoTimer = setInterval(function () {
	          _this3.getListening().then(function (_ref) {
	            var _ref2 = _slicedToArray(_ref, 2);

	            var err = _ref2[0];
	            var connected = _ref2[1];

	            if (connected) {
	              clearInterval(nodeInfoTimer);
	              return _this3.getNodeInfo();
	            }
	            ...
	            var err = _ref6[0];
	            var accounts = _ref6[1];

	            _this3.defaultAccount = accounts[0];
	            resolve(_this3);
	          });
	        }, 1000);
	      });
	    ...
	    value: function getListening() {
	      ...
	      var defer = new Promise(function (resolve, reject) {
	        _this4.web3.net.getListening(function (err, listening) {
	    ...
	    value: function getNodeInfo() {
	      ...
	      var defer = new Promise(function (fufill, reject) {
	        _this5.web3.admin.getNodeInfo(function (err, nodeInfo) {
	          fufill([err, nodeInfo]);
	        });
	      });
	    ...
	    value: function addAllPeers() {
	      ...
	      var defer = new Promise(function (fufill, reject) {
	        Promise.all(addPeerPromises).then(function () {
	          fufill();
	        });
	      });
	      return defer;
	    ...
	    value: function getPeers() {
	      ...
	      var defer = new Promise(function (fufill, reject) {
	        _this10.web3.admin.getPeers(function (err, peers) {
	          fufill([err, peers]);
	        });
	      });
	    ...
	    value: function sendTransaction(txObj) {
	      ...
	      var defer = new Promise(function (fufill, reject) {
	        _this11.web3.eth.sendTransaction(txObj, function (err, result) {
	          fufill([err, result]);
	        });
	      });
	    ...
	    */
	    ...
	    key: 'txFilter',
	    value: function txFilter(callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageGraph = __webpack_require__(165);

	var _EthereumNetwork = __webpack_require__(2);

	var _Analysis = __webpack_require__(166);
	...
	var NodeButton = _react2.default.createClass({
	  displayName: 'NodeButton',
	  ...
	  onClick: function onClick() {
	    switch (this.props.role) {
	      case _globals.MICROBE:
	        ...
	        break;
	      case _globals.MACROPHAGE:
	        _EthereumNetwork.EthereumNetwork.toggleMacrophage(_EthereumNetwork.EthereumNetwork.getNodeByID(this.props.nodeID));
	        break;
	      default:
	    }
	...
	var Home = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      peerIDs: _EthereumNetwork.EthereumNetwork.getNodeIDs(),
	      shouldUpdateDOM: true,
	      selectorType: _globals.MICROBE
	    };
	  },
	  componentWillMount: function componentWillMount() {
	    var updateNodes = function updateNodes() {
	      var nodeIDs = _EthereumNetwork.EthereumNetwork.getNodeIDs();
	      var existsDifferentNode = this.state.peerIDs.some(function (v, i) {
	        return v.localeCompare(nodeIDs[i]) !== 0;
	      });
	  ...
	  changeSelectorType: function changeSelectorType(event) {
	    this.setState({ selectorType: event.target.value, shouldUpdateDOM: true });
	    _NetworkGraph.networkGraph.setSelectorType(event.target.value);
	  },
	  sendMessage: function sendMessage() {
	    var selectedNode = _EthereumNetwork.EthereumNetwork.getMicrobe();
	  ...
	  runEMAnalysis: function runEMAnalysis() {
	    _MessageGraph.messageGraph.updateData(_Analysis.analysis.withEM());
	  },
	  resetAnalysis: function resetAnalysis() {
	    _Analysis.analysis.reset();
	  },
	  ...
	  componentDidMount: function componentDidMount() {
	    _NetworkGraph.networkGraph.init('#networkGraph', this.forceUpdate.bind(this));
	    _NetworkGraph.networkGraph.setSelectorType(_globals.MICROBE);
	    _MessageGraph.messageGraph.init('#messageGraph', this.forceUpdate.bind(this));
	    this.setState({
	      shouldUpdateDOM: false
	    });
	    this.updateNetworkGraphData();
	  },
	  updateNetworkGraphData: function updateNetworkGraphData() {
	    var _this2 = this;

	    var ethereumNodes = this.state.peerIDs.map(function (nodeID) {
	      return _EthereumNetwork.EthereumNetwork.getNodeByID(nodeID);
	    });

	    var getPeersPromises = ethereumNodes.map(function (node) {
	      return new Promise(function (fufill, reject1) {
	        node.getPeers().then(function (_ref3) {
	          var _ref4 = _slicedToArray(_ref3, 2);

	          var err = _ref4[0];
	          var peers = _ref4[1];

	          fufill(peers.filter(function (peer) {
	            return _this2.state.peerIDs.includes(peer.id);
	          }).map(function (peer) {
	    ...
	    Promise.all(getPeersPromises).then(function (peerLinks) {
	      var graphData = {};
	      graphData.nodes = _this2.state.peerIDs;
	      graphData.links = [].concat.apply([], peerLinks);
	      _NetworkGraph.networkGraph.upsertGraphData(graphData);
	    });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.NetworkGraph = exports.networkGraph = undefined;
	...
	var NetworkGraph = function () {
	  ...
	  */
	  ...
	  _createClass(NetworkGraph, [{
	    key: 'init',
	    value: function init(selection, updateDOM) {
	      var _this = this;
	      ...
	      vis.on('click', function () {
	        ...
	        _this._selectedConnection = null;
	        $('#networkGraph').unbind('mousemove');
	        _this._selectedGodsnode = null;
	        _this._updateDOM();
	      });
	      this.force = d3.layout.force().size([this.width, this.height]).charge(-1000).linkDistance(100).on('tick', this._forceTick.bind(this));
	      this.update();
	    }
	  }, {
	    key: '_forceTick',
	    value: function _forceTick(e) {
	      var node = this.nodesG.selectAll('circle.node').data(this.curNodesData, function (d) {
	        return d.nodeID;
	      });
	      ...
	      var link = this.linksG.selectAll('line.link').data(this.curLinksData, function (d) {
	    ...
	    value: function _messageListener(targetNode, data) {
	      var _this2 = this;

	      var message = data.data;
	      if (!_EthereumNetwork.EthereumNetwork.getNodeIDs().includes(message.from)) {
	        return;
	      }

	      this.linksG.selectAll('line.link').filter(function (d) {
	        var hasSource1 = d.source.nodeID.localeCompare(targetNode.nodeID) === 0;
	        var hasTarget1 = d.target.nodeID.localeCompare(message.from) === 0;
	        var hasSource2 = d.source.nodeID.localeCompare(message.from) === 0;
	        var hasTarget2 = d.target.nodeID.localeCompare(targetNode.nodeID) === 0;
	        return hasSource1 && hasTarget1 || hasSource2 && hasTarget2;
	      }).call(function (ds) {
	        if (ds.empty()) {
	          return;
	        }
	        _this2.messagesG.append('circle').attr('class', 'message').attr('cx', function (d) {
	          return _EthereumNetwork.EthereumNetwork.getNodeByID(message.from).x;
	        }).attr('cy', function (d) {
	          return _EthereumNetwork.EthereumNetwork.getNodeByID(message.from).y;
	        }).attr('r', function (d) {
	          return 10;
	        }).style('stroke-width', 1.0).transition().duration(4000).attrTween('cx', function (d, i, a) {
	          return function (t) {
	            var cx0 = _EthereumNetwork.EthereumNetwork.getNodeByID(message.from).x;
	            var cx1 = targetNode.x;
	            var terpolater = d3.interpolateRound(cx0, cx1);
	            return terpolater(t);
	          };
	        }).attrTween('cy', function (d, i, a) {
	          return function (t) {
	            var cy0 = _EthereumNetwork.EthereumNetwork.getNodeByID(message.from).y;
	            var cy1 = targetNode.y;
	            var terpolater = d3.interpolateRound(cy0, cy1);
	            return terpolater(t);
	          };
	        }).attr('r', function (d) {
	          return 20;
	        }).attr('fill', '#5066a1').remove();
	      });
	    }
	  }, {
	    key: '_updateNodes',
	    value: function _updateNodes() {
	      ...
	      node.enter().call(function (d) {
	        if (d[0].length > 0) {
	          d3.selectAll(d[0]).data().forEach(function (ethereumNode) {
	            ethereumNode.txFilter(_this3._messageListener.bind(_this3));
	          });
	        }
	        ...
	        return d.r;
	      }).style('stroke-width', 2).on('mouseup', function (d) {
	        ...
	        switch (networkGraph.getSelectorType()) {
	          case _globals.MICROBE:
	            _EthereumNetwork.EthereumNetwork.toggleMicrobe(_EthereumNetwork.EthereumNetwork.getNodeByID(d.nodeID));
	            break;
	          case _globals.MACROPHAGE:
	            _EthereumNetwork.EthereumNetwork.toggleMacrophage(_EthereumNetwork.EthereumNetwork.getNodeByID(d.nodeID));
	            break;
	          default:
	        }
	    ...
	    value: function _updateLinks() {
	      ...
	      link.enter().append('line').attr('class', 'link').attr('stroke', '#ddd').style('stroke-width', 5).attr('x1', function (d) {
	        return d.source.x;
	      }).attr('y1', function (d) {
	        return d.source.y;
	      }).attr('x2', function (d) {
	        ...
	        if (_this4._selectorType.localeCompare(_globals.CONNECTION) === 0) {
	          d.source.removePeer(d.target.nodeID).then(function () {
	            ...
	            _this4.graphData.links.forEach(function (curLink, i) {
	              if (curLink === d) {
	                _this4.graphData.links.splice(i, 1);
	                _this4.update();
	              }
	            });
	          });
	    ...
	    */
	    ...
	    key: 'upsertGraphData',
	    value: function upsertGraphData(newData) {
	      var _this5 = this,
	          _graphData$nodes,
	          _graphData$links;
	      ...
	      var filteredData = { nodes: [], links: [] };
	      newData.nodes.forEach(function (nodeID) {
	        var node = _EthereumNetwork.EthereumNetwork.getNodeByID(nodeID);
	        if (!_this5.graphData.nodes.includes(node)) {
	          filteredData.nodes.push(nodeID);
	        }
	      });

	      newData.links.forEach(function (link1) {
	        var source = link1.source.localeCompare(link1.target) > 0 ? link1.source : link1.target;
	        var target = link1.source.localeCompare(link1.target) > 0 ? link1.target : link1.source;

	        var linkExists = _this5.graphData.links.some(function (link2) {
	          return source.localeCompare(link2.source.nodeID) === 0 && target.localeCompare(link2.target.nodeID) === 0;
	        });
	        if (!linkExists) {
	      ...
	      (_graphData$nodes = this.graphData.nodes).push.apply(_graphData$nodes, _toConsumableArray(newNodes));
	      var newLinks = filteredData.links.map(function (l) {
	        //order statically to prevent duplicates
	        var source = l.source.localeCompare(l.target) > 0 ? l.source : l.target;
	        var target = l.source.localeCompare(l.target) > 0 ? l.target : l.source;
	        return {
	          source: _EthereumNetwork.EthereumNetwork.getNodeByID(source),
	          target: _EthereumNetwork.EthereumNetwork.getNodeByID(target)
	        };
	      });
	      newLinks.forEach(function (link1, i1, links1) {
	        links1.some(function (link2, i2, links2) {
	          if (i1 == i2) {
	            return false;
	          }
	      ...
	      (_graphData$links = this.graphData.links).push.apply(_graphData$links, _toConsumableArray(newLinks));
	      this.update();
	    }
	  }, {
	    key: 'setSelectedNode',
	    value: function setSelectedNode(selectedNode) {
	      var _this6 = this;
	      ...
	      if (this._selectorType.localeCompare(_globals.CONNECTION) === 0) {
	        if (this._selectedConnection) {
	          ...
	          var selectedConnection = this.nodesG.selectAll('circle.node').filter(function (d) {
	            return selectedNode.nodeID.localeCompare(d.nodeID) == 0;
	          });

	          var link = networkGraph.linksG.selectAll('line.mouselink').data([selectedNode], function (data) {
	            return data.nodeID;
	          });
	          link.enter().append('line').attr('class', 'mouselink').attr('stroke', '#0f0').attr('stroke-width', 4).attr('x1', function () {
	          ...
	          $('#networkGraph').mousemove(function (event) {
	            var x = event.pageX - $('#networkGraph').offset().left;
	            var y = event.pageY - $('#networkGraph').offset().top;

	            networkGraph.linksG.selectAll('line.mouselink').attr('x1', function () {
	              return _this6._selectedConnection.data()[0].x;
	            }).attr('y1', function () {
	              return _this6._selectedConnection.data()[0].y;
	            }).attr('x2', function () {
	              return x;
	            }).attr('y2', function () {
	              return y;
	      ...
	      if (networkGraph._selectorType.localeCompare(_globals.GODSNODE) === 0) {
	        if (this._selectedGodsnode) {
	          ...
	          (function () {
	            var godsNode = networkGraph.nodesG.selectAll('circle.node').filter(function (circleNode) {
	            ...
	            _this6._selectedGodsnode = godsNode;
	            d3.event.stopPropagation();
	          })();
	        }
	      }
	    ...
	    key: 'setSelectorType',
	    value: function setSelectorType(role) {
	...
	exports.networkGraph = networkGraph = new NetworkGraph();
	  ...
	  */
	  ...
	  _createClass(MessageGraph, [{
	    ...
	    value: function init(selection, updateDOM) {
	      this._updateDOM = updateDOM;
	      this.messageData = [];
	      this.svg = d3.select(selection).append('svg').attr('width', this.width).attr('height', this.height);
	    ...
	    value: function _update() {
	      ...
	      var rect = this.messagesG.selectAll('rect').data(this.messageData);

	      rect.enter().append('rect').attr('rx', 5).attr('ry', 5).attr('x', 0).attr('y', 0).attr('transform', rectTransform).attr('width', function (d) {
	        return x.rangeBand();
	      }).attr('height', function (d) {
	        return y.rangeBand();
	      }).attr('fill', '#000').attr('fill-opacity', function (d, i) {
	    ...
	    */
	    ...
	    value: function updateData(newData) {
	      var flatDataMap = {};
	      newData.forEach(function (assignorData) {
	        assignorData.forEach(function (data) {
	      ...
	      var flatData = Object.keys(flatDataMap).map(function (key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Analysis = function () {
	  function Analysis() {
	    ...
	    _EthereumNetwork.EthereumNetwork.getNodeIDs().map(function (nodeID) {
	      return _EthereumNetwork.EthereumNetwork.getNodeByID(nodeID);
	    }).forEach(function (node) {
	      _this.txHashFrequency[node.nodeID] = {};
	      _this.txHashMessages[node.nodeID] = {};
	      node.txFilter(_this._update.bind(_this));
	    });

	    _EthereumNetwork.EthereumNetwork.nodeFilter(function (node) {
	      _this.txHashFrequency[node.nodeID] = {};
	      _this.txHashMessages[node.nodeID] = {};
	      node.txFilter(_this._update.bind(_this));
	    });
	  ...
	  _createClass(Analysis, [{
	    key: '_update',
	    value: function _update(targetNode, data) {
	      var message = data.data;
	    ...
	    */
	    ...
	    value: function reset() {
	      ...
	      Object.keys(this.txHashFrequency).forEach(function (nodeID) {
	        _this2.txHashFrequency[nodeID] = {};
	      });
	      Object.keys(this.txHashMessages).forEach(function (nodeID) {
	        _this2.txHashMessages[nodeID] = {};
	      });
	    ...
	    key: 'getPayloadHashFrequency',
	    value: function getPayloadHashFrequency() {
	      return this.txHashFrequency;
	    }
	  }, {
	    key: 'addMicrobeTxHash',
	    value: function addMicrobeTxHash(hash) {
	    ...
	    */
	    ...
	    key: 'withEM',
	    value: function withEM() {
	      var _this3 = this;

	      //it's very important to be able to handle missing data to work with
	      //sorted data.
	      var sortedAllNodeIDs = Object.keys(this._networkNodeIDs).sort();
	...
	*/
	Analysis.estep = function (X, K, Mu, P, Sigma) {
	  ...
	  X.forEach(function (x, t) {
	    ...
	    x = x.filter(function (x0, e) {
	      return delta[e] == 1;
	    });

	    var likelihoods = [];
	    for (var j = 0; j < K; j++) {
	      var mu = Mu[j].filter(function (x0, e) {
	        return delta[e] == 1;
	      });
	      var sigma = Sigma[j];
	      var logScaledWeightedDensity = Math.log(P[j]) + Analysis.logN(x, mu, sigma);
	      likelihoods.push(logScaledWeightedDensity);
	    }
	    var densityPrime = Math.max.apply(Math, likelihoods); //logarithm magic follows
	    var eLikelihoods = likelihoods.map(function (density) {
	      return Math.exp(density - densityPrime);
	    });
	    var shiftedSum = eLikelihoods.reduce(function (a, b) {
	      return a + b;
	    });
	    var likelihoodsum = densityPrime + Math.log(shiftedSum);
	    LL += likelihoodsum;

	    for (var _j = 0; _j < K; _j++) {
	      var _mu = Mu[_j].filter(function (x0, e) {
	        return delta[e] == 1;
	      });
	      var _sigma = Sigma[_j];
	      var _logScaledWeightedDensity = Math.log(P[_j]) + Analysis.logN(x, _mu, _sigma);
	      post[_j][t] = Math.exp(_logScaledWeightedDensity - likelihoodsum);
	    }
	  });
	  return [post, LL];
	};
	...
	*/
	Analysis.mstep = function (X, K, Mu, P, Sigma, post) {
	  ...
	  P.forEach(function (p, j) {
	    ...
	    var nj = post[j].reduce(function (a, b) {
	      return a + b;
	    });
	    ...
	    X.forEach(function (x, t) {
	      ...
	      var deltasize = delta.filter(function (e) {
	        return e !== 0;
	      }).length;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (typeof window !== 'undefined') {
	  ...
	  mounter = __webpack_require__(227).mounter;
	} else {
	  mounter = __webpack_require__(238).mounter;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(184).Array.from;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(187)(IteratorPrototype, __webpack_require__(217)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domready = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getKeys  = __webpack_require__(203)
	  , gOPS     = __webpack_require__(236)
	  , pIE      = __webpack_require__(237)
	  , toObject = __webpack_require__(219)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _server = __webpack_require__(239);
